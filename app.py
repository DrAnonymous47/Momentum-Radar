...
# 2. VOLLSTÄNDIGE & PRÄZISE AKTIEN-DATENBANK
DEUTSCHE_AKTIEN = {
    # --- DAX 40 ---
    "ADS.DE": ("Adidas", "DAX"),
    "AIR.DE": ("Airbus", "DAX"),
    ...
    "AMZ.DE": ("SMA Solar", "MDAX"),
    "BC8.DE": ("Bechtle", "MDAX"),
    "BKN.DE": ("Bilfinger", "MDAX"),
    "BOSS.DE": ("Hugo Boss", "MDAX"),
    "CTS.DE": ("CTS Eventim", "MDAX"),
    "DEL2.DE": ("Delivery Hero", "MDAX"),
    "EVK.DE": ("Evonik Industries", "MDAX"),
    "EVT.DE": ("Evotec", "MDAX"),
    "FME.DE": ("Fresenius Medical Care", "MDAX"),
    "FRA.DE": ("Fraport", "MDAX"),
    "FPE3.DE": ("Fuchs SE", "MDAX"),
    ...
    "RDC.DE": ("Redcare Pharmacy", "MDAX"),
    "SHA.DE": ("Schaeffler", "MDAX"),
    "SIX2.DE": ("Sixt SE", "MDAX"),
    "SVAB.DE": ("Ströer", "MDAX"),
    "TAG.DE": ("TAG Immobilien", "MDAX"),
    "TKA.DE": ("Thyssenkrupp", "MDAX"),
    "TMV.DE": ("TeamViewer", "MDAX"),
    "TLX.DE": ("Talanx", "MDAX"),
    "TUI1.DE": ("TUI AG", "MDAX"),
    "UTDI.DE": ("United Internet", "MDAX"),
    ...
    "COK.DE": ("Cancom", "SDAX"),
    "DNX.DE": ("Dermapharm", "SDAX"),
    "DRW3.DE": ("Drägerwerk", "SDAX"),
    "ELG.DE": ("Elmos Semiconductor", "SDAX"),
    "FNTN.DE": ("Freenet", "SDAX"),
    "GFT.DE": ("GFT Technologies", "SDAX"),
    "GLJ.DE": ("GRENKE AG", "SDAX"),
    "HDD.DE": ("Heidelberger Druck", "SDAX"),
    "HHFA.DE": ("HHLA", "SDAX"),
    "HOC.DE": ("Hornbach Holding", "SDAX"),
    "JEN.DE": ("Jenoptik", "SDAX"),
    "KCO.DE": ("Klöckner & Co", "SDAX"),
    "KSB3.DE": ("KSB SE", "SDAX"),
    "KWS.DE": ("KWS Saat", "SDAX"),
    "LPK.DE": ("LPKF Laser", "SDAX"),
    "MDN.DE": ("MEDION", "Prime Standard"),
    "MLP.DE": ("MLP SE", "SDAX"),
    "MOR.DE": ("MorphoSys", "SDAX"),
    "PNE.DE": ("PNE AG", "SDAX"),
    "SGL.DE": ("SGL Carbon", "SDAX"),
    "SMT.DE": ("SUSS MicroTec", "SDAX"),
    "VOS.DE": ("Vossloh", "SDAX"),
    "VAR1.DE": ("VARTA AG", "Prime Standard"),
    "HAB.DE": ("Hamborner REIT", "SDAX"),
    "SFQ.DE": ("SAF-Holland", "SDAX"),
    "WAC.DE": ("Wacker Neuson", "SDAX")
}

# 3. FAST BATCH DATA LOADING
@st.cache_data(ttl=300)
def load_market_data():
    tickers = list(DEUTSCHE_AKTIEN.keys())
    
    # Paralleler Download über yfinance
...
def main():
    ...
    with st.spinner("Scanne deutsche Aktientitel in Echtzeit von XETRA..."):
